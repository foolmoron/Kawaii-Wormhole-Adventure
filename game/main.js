    ...
    var game,
        ...
        KWA.STATES.preloader = {
            preload: function() {
                ...
                game.load.audio('main', 'audio/maintheme.ogg');
                game.load.audio('generic', 'audio/generictheme.ogg');
                game.load.audio('may', 'audio/maytheme.ogg');
                game.load.audio('jay', 'audio/jaytheme.ogg');
            },
            create: function() {
