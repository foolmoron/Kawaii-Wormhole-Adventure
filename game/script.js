...
\* * * * * * * * * * * * * * * * * * * */
KWA.SCRIPT = [
	{name: 'one', func: ['characterLeftSlideIn','characterRightSlideIn'], dialogue: "9", background: 'background3', characterLeft: 'jay2', characterRight: 'jay1', advance: 1},
	{label: 'two', func: ['characterLeftSlideOut','characterRightSlideOut'], name: 'two', dialogue: "hey test2 hey test2 hey test2 hey test2 hey test2 hey test2 hey test2hey test2 hey test2 hey test2 hey test2 hey test2 hey test2 hey test2hey test2 hey test2 hey test2 hey test2 hey test2 hey test2 hey test2", background: 'background2', characterLeft: 'may2', characterRight: 'may1', advance: 1},
	{name: 'three', func: ['characterLeftFadeIn','characterRightFadeIn'], dialogue: "hey test3 hey test3 hey test3 hey test3 hey test3 hey test3 hey test3hey test3 hey test3 hey test3 hey test3 hey test3 hey test3 hey test3hey test3 hey test3 hey test3 hey test3 hey test3 hey test3 hey test3", background: 'background1', characterLeft: 'may2', characterRight: 'jay1', advance: 1},
	{name: 'four', func: ['characterLeftFadeOut','characterRightFadeOut'], dialogue: "hey test4 hey test4 hey test4 hey test4 hey test4 hey test4 hey test4hey test4 hey test4 hey test4 hey test4 hey test4 hey test4 hey test4hey test4 hey test4 hey test4 hey test4 hey test4 hey test4 hey test4", background: 'background1', characterLeft: 'jay2', characterRight: 'may1', advance: 'restart'},
