...
KWA.SCRIPT = [
    ...
    /* APARTMENT */ { name: "Window", dialogue: "*crash*", background: 'bgroom', music: 'generic', func: 'screenShake'},
    ...
    /* MAY INTRO */ { label: 'mayintro', name: "{mc}", dialogue: "...", background: 'bgmanor', music: 'may', func: 'fadeIn', options: {duration: 2000}},
    ...
    /* JAY INTRO */ { label: 'jayintro', name: "{mc}", dialogue: "...", background: 'bgmoon', music: 'jay', func: 'fadeIn', options: {duration: 2000}},
    ...
    { name: "May", dialogue: "{mc}, you knew what you were doing when you brought us together.", characterRight: 'maysexy', characterLeft: 'jaysexy'},
